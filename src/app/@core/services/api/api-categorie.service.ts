...
@Injectable()
export class ApiCategorieService extends CategorieService{
    ...
    getAllCategorie(showErrorNotif:boolean, getTableDataParam: GetTableDataParam): Observable<HttpResponse<ApiResponse<Datatable<Array<Categorie>>>> | Observable<never>>{
        return this.apiService.post<ApiResponse<Datatable<Array<Categorie>>>>(environment.getAllPicklistUri, getTableDataParam).pipe(
            map((x: HttpResponse<ApiResponse<Datatable<Array<Categorie>>>>) => {
                //console.log("All categories :",x);

                return this.handleResponse<ApiResponse<Datatable<Array<Categorie>>>>(showErrorNotif, x);
            }),
            catchError(error => {
    ...
    createCategorie(showErrorNotif:boolean, picklist:Picklist): Observable<HttpResponse<any> | Observable<never>>{
